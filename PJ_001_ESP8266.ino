...
void setup() {
  ...
  ctrl.begin(
    STEP_PIN, DIR_PIN, ENA_PIN, ENA_ACTIVE_LOW,
    LIMIT_BOTTOM, /*limitActiveLow=*/true,
    kStepsPerRev, kOpenTurns);
  applyMotionParams();

  // Réseau & UI
  WebUI::setCallbacks(onOpen, onClose, onStop, onSetTurns, onSetSpeed, onSetAccel, getStatus);
